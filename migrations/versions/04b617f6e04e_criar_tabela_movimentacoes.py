...
Revision ID: 04b617f6e04e
Revises: fe53565e0f39
Create Date: 2026-05-28 16:22:39.639931
...
revision: str = '04b617f6e04e'
down_revision: Union[str, Sequence[str], None] = 'fe53565e0f39'
...
def upgrade() -> None:
    ...
    sa.Column('tipo', sa.Enum('ENTRADA', 'SAIDA', 'AJUSTE', 'CANCELAMENTO', name='tipomovimentacao'), nullable=False),
