"""criar tabelas clientes vendas itens_venda

Revision ID: ed8cdfc65490
Revises: 292af852a9fa
Create Date: 2026-05-31 10:34:59.541602
...
revision: str = 'ed8cdfc65490'
down_revision: Union[str, Sequence[str], None] = '292af852a9fa'
...
def upgrade() -> None:
    ...
    op.alter_column('movimentacoes', 'tipo',
               ...
               type_=sa.Enum('ENTRADA', 'SAIDA', name='tipomovimentacao'),
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    # op.alter_column('movimentacoes', 'tipo',
    #            existing_type=sa.Enum('ENTRADA', 'SAIDA', name='tipomovimentacao'),
